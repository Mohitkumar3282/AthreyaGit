...
const ActiveSellers = () => {
  ...
  useEffect(() => {
    const handleOutsideClick = (e) => {
      if (activeDropdownId && !e.target.closest(".actions-dropdown-container")) {
                    ...
                    <td className="px-6 py-4 text-left">
                      <div className="actions-dropdown-container relative inline-block text-left">
                        <button
                          ...
                          className="p-2 hover:bg-slate-100 rounded-xl transition-all border border-slate-200/60 text-slate-500 hover:text-slate-700 shadow-sm bg-white"
                          title="Actions"
                        >
                        ...
                        <AnimatePresence>
                          {activeDropdownId === (seller.id || seller._id) && (
                            <motion.div
                              initial={{ opacity: 0, scale: 0.95, y: -10 }}
                              animate={{ opacity: 1, scale: 1, y: 0 }}
                              exit={{ opacity: 0, scale: 0.95, y: -10 }}
                              transition={{ duration: 0.12 }}
                              className="absolute right-0 mt-2 w-48 bg-white border border-slate-100 rounded-2xl shadow-2xl z-[100] p-1.5 flex flex-col gap-0.5"
                            >
                              <button
                                onClick={() => {
                                  handleApproveShop(seller.id || seller._id);
                                  setActiveDropdownId(null);
                                }}
                                className="w-full px-3 py-2.5 text-left text-xs font-bold text-emerald-600 hover:bg-emerald-50 rounded-xl transition-all flex items-center gap-2"
                              >
                              ...
                              <button
                                onClick={() => {
                                  handleUpdateStatusRow(seller, true);
                                  setActiveDropdownId(null);
                                }}
                                className="w-full px-3 py-2.5 text-left text-xs font-bold text-blue-600 hover:bg-blue-50 rounded-xl transition-all flex items-center gap-2"
                              >
                              ...
                              <button
                                onClick={() => {
                                  handleUpdateStatusRow(seller, false);
                                  setActiveDropdownId(null);
                                }}
                                className="w-full px-3 py-2.5 text-left text-xs font-bold text-rose-600 hover:bg-rose-50 rounded-xl transition-all flex items-center gap-2"
                              >
                                <HiOutlineXCircle className="h-4 w-4 text-rose-500" />
                                Deactivate Seller
                              </button>
                              ...
                              <button
                                ...
                                className="w-full px-3 py-2.5 text-left text-xs font-bold text-slate-700 hover:bg-slate-50 rounded-xl transition-all flex items-center gap-2"
                              >
